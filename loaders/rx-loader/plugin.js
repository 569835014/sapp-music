...
class VueLoaderPlugin {
  apply (compiler) {
    ...
    let vueRuleIndex = rawRules.findIndex(createMatcher(`foo.mina`))
    if (vueRuleIndex < 0) {
      vueRuleIndex = rawRules.findIndex(createMatcher(`foo.mina.html`))
    }
    ...
    const vueLoaderUseIndex = vueUse.findIndex(u => {
      return /^rx-loader|(\/|\\|@)vue-loader/.test(u.loader)
    })
